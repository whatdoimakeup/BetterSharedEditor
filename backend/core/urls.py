...
urlpatterns = [
    ...
    path("rooms/<int:room_id>/state/", views.RoomStateView.as_view(), name="room-state"),
    path("rooms/<int:room_id>/yjs_update/", views.RoomUploadUpdateView.as_view(), name="room-yjs-update"),
